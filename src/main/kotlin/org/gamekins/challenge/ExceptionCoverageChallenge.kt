...
class ExceptionCoverageChallenge(data: Challenge.ChallengeGenerationData)
    ...
    /**
     * Checks whether the [ExceptionCoverageChallenge] is solvable if the [run] was in the branch (taken from
    ...
    /**
     * The [ExceptionCoverageChallenge] is solved if the line, according to the [details] JaCoCo files, is fully
